#############################################################################
# Makefile for building: p1_ai
# Generated by qmake (3.0) (Qt 5.7.0)
# Project:  ../p1_ai/p1_ai.pro
# Template: app
# Command: /home/pd2vm/Qt5.7.0/5.7/gcc_64/bin/qmake -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ../p1_ai/p1_ai.pro
#############################################################################
...
INCPATH       = -I../p1_ai -I. -I../../Qt5.7.0/5.7/gcc_64/mkspecs/linux-g++
...
COMPRESS      = gzip -9f
DISTNAME      = p1_ai1.0.0
DISTDIR = /home/pd2vm/Project_1/build-p1_ai-Desktop_Qt_5_7_0_GCC_64bit-Debug/.tmp/p1_ai1.0.0
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS)  
AR            = ar cqs
...
DIST          = ../../Qt5.7.0/5.7/gcc_64/mkspecs/features/spec_pre.prf \
		...
		../p1_ai/p1_ai.pro troop.h \
		point.h ../p1_ai/main.cpp \
		../p1_ai/troop.cpp \
		../p1_ai/point.cpp
QMAKE_TARGET  = p1_ai
DESTDIR       = 
...
Makefile: ../p1_ai/p1_ai.pro ../../Qt5.7.0/5.7/gcc_64/mkspecs/linux-g++/qmake.conf ../../Qt5.7.0/5.7/gcc_64/mkspecs/features/spec_pre.prf \
		../../Qt5.7.0/5.7/gcc_64/mkspecs/common/unix.conf \
		../../Qt5.7.0/5.7/gcc_64/mkspecs/common/linux.conf \
		../../Qt5.7.0/5.7/gcc_64/mkspecs/common/sanitize.conf \
		../../Qt5.7.0/5.7/gcc_64/mkspecs/common/gcc-base.conf \
		...
		../../Qt5.7.0/5.7/gcc_64/mkspecs/features/lex.prf \
		../p1_ai/p1_ai.pro
	$(QMAKE) -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ../p1_ai/p1_ai.pro
...
main.o: ../p1_ai/main.cpp ../p1_ai/troop.h \
		../p1_ai/point.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o ../p1_ai/main.cpp

troop.o: ../p1_ai/troop.cpp ../p1_ai/troop.h \
		../p1_ai/point.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o troop.o ../p1_ai/troop.cpp

point.o: ../p1_ai/point.cpp ../p1_ai/point.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o point.o ../p1_ai/point.cpp
